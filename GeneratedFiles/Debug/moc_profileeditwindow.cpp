...
QT_MOC_LITERAL(4, 34, 6) // "submit"

    },
    "ProfileEditWindow\0cancel\0\0success\0"
    "submit"
};
...
void ProfileEditWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cancel((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->success((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (ProfileEditWindow::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProfileEditWindow::cancel)) {
                *result = 0;
            }
        }
        {
            typedef void (ProfileEditWindow::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProfileEditWindow::success)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ProfileEditWindow::staticMetaObject = {
    { &PostureWindow::staticMetaObject, qt_meta_stringdata_ProfileEditWindow.data,
...
// SIGNAL 0
void ProfileEditWindow::cancel(const QString & _t1)
{
...
// SIGNAL 1
void ProfileEditWindow::success(const QString & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

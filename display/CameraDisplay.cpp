...
#include "CameraDisplay.h"                    /**< 包含摄像机头文件 */

CameraDisplay* CameraDisplay::m_pCamera = NULL;
...
/** 设置摄像机的位置,朝向和向上向量 */
void CameraDisplay::setCamera(float positionX, float positionY, float positionZ,
...
/**  旋转摄像机方向  */
void CameraDisplay::rotateView(float angle, float x, float y, float z)
{
	Vector3 newView;
...
/** 用鼠标旋转摄像机 */
void CameraDisplay::setViewByMouse()
{
...
/** 左右移动摄像机 */
void CameraDisplay::yawCamera(float speed)
{
	Vector3 yaw;
...
/** 前后移动摄像机 */
void CameraDisplay::moveCamera(float speed)
{
	/** 计算方向向量 */
